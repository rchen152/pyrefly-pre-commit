...
There are two ways to use the `pyrefly` hook. Add one of the following to your project's `.pre-commit-config.yaml`:
...
repos:
  - repo: https://github.com/facebook/pyrefly-pre-commit
    rev: 0.42.0  # Note: this can be any valid pyrefly version >=0.42.0
    hooks:
      - id: pyrefly
...
The hook will be able to see your project's other dependencies when type checking.
